...
public class BudgetViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
    ...
    public BudgetViewHolder(final View itemView, Context currentAct) {
        super(itemView);
        lb_name = (TextView) itemView.findViewById(R.id.lg_name);
        lb_totamt = (TextView) itemView.findViewById(R.id.lg_invitation);
        lb_paidamt = (TextView) itemView.findViewById(R.id.lg_name);
